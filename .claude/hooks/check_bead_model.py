...
A bare newline between commands in one Bash call is ALSO not segmented (shlex treats it
as ordinary whitespace, not a separator token) -- tracked separately, see agent_rules-96o.
